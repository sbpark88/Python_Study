...
def createtable(engine):
    try :
        engine.execute("CREATE TABLE db_blockchain (index varchar(100),                                    previoushash varchar(100),                                    timestamp varchar(100),                                    data varchar(100),                                    currenthash varchar(100),                                    proof varchar(100));")
        engine.execute("CREATE TABLE db_txdata (commityn integer,                                    sender varchar(100),                                    amount varchar(100),                                    receiver varchar(100),                                    uuid_str varchar(100));")
        engine.execute("CREATE TABLE db_node (ip varchar(100),                                    port varchar(100),                                    failnum varchar(100));")
