...
# 1.2 데이터베이스 관련 전역변수. create_engine / mariadb.connect 시 사용
#engineInfo = "mysql+mysqldb://kopo:kopo@localhost/health"
engineInfo = "mysql+mysqldb://root:kopokopo123@52.79.196.232:3636/health"
#config = {"user":"kopo", "password":"kopo", "host":"localhost", "port":3306, "db":"health"}
config = {"user":"root", "password":"kopokopo123", "host":"52.79.196.232", "port":3636, "db":"health"}
...
#         recentHealthDF = eachHealthDF if eachLastTime == beforeLastTime else eachHealthDF.loc[eachLastTime.create_time > beforeLastTime]
